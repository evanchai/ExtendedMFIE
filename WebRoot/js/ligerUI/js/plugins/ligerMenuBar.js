		...
		return this.each(function() {
			...
			var g = {
				addItem : function(item) {
					if(item.line) {
						g.menubar.append('<div class="l-menubar-item-line l-menubar-item l-panel-btn"></div>');
						return;
					}
					...
					//Jeff
					item.text && $("span:first", ditem).html("<div><img src=" + item.icon + " class='img_32'/><p>" + item.text + "</p></div>");
					//End Jeff
