...
<title>${post.title }- Stack Overflow</title>
...
<%
	//璺冲叆Servlet璇诲彇鏁版嵁,涓轰簡闃叉涓�鐩磋烦杞紝鎵�浠ョ敤if鏉ュ垽鏂�
	...
	<div class="topbar">
					...
					<div class="modal-content current-site-container">
						<ul class="current-site">
							<li>
								...
								</div> <a href="http://stackoverflow.com/"
        ...
        site_switcher.click({ item_type:3 })">
							...
							<li class="related-site">
								...
								</div> <a href="http://meta.stackoverflow.com/"
        ...
        site_switcher.click({ item_type:4 })">
							...
							<li class="related-site">
								<div class="L-shaped-icon-container">
									<span class="L-shaped-icon"></span>
								</div> <a class="site-link js-gps-track"
					...
					<div id="hero-content">
						<span id="controls"> <a
							...
							class="button">Take the 2-minute tour</a> <span id="close"><a
								title="click to dismiss">脳</a></span>
						</span>
            ...
            return false;
				...
				<div id="question-header">
					<h1 itemprop="name">
						<a
							href="./vim - paste data at the start of line in visual mode - Stack Overflow_files/vim - paste data at the start of line in visual mode - Stack Overflow.html"
							class="question-hyperlink">${post.title }</a>
					</h1>
				</div>
				<div id="mainbar">
						...
						<table>
							<tbody>
								<tr>
									<td class="votecell">
										...
										<div class="vote">
											<input type="hidden" name="_id_" value="27420164"> <a
												...
												vote</a> <span itemprop="upvoteCount" class="vote-count-post ">${post.score}</span>
									...
									<td class="postcell">
										<div>
											<div class="post-text" itemprop="text">${post.body }</div>
											<div class="post-taglist">
		
											<c:forEach items="${post.tag }" var="t">
															...
															<div class="user-info ">
																<div class="user-action-time">
																	<a
																		...
																		title="2014-12-11 10:40:43Z" class="relativetime">${post.lastEditDate }</span></a>
																</div>
															...
															<div class="user-info user-hover">
																<div class="user-action-time">
																	asked <span title="2014-12-11 10:10:04Z"
																		class="relativetime">${post.writeDate }</span>
																</div>
																...
																<div class="user-details">
																	<a
																		href="http://stackoverflow.com/users/1860929/mu-%e7%84%a1">${post.ownerUserId}${post.ownerDisplayName }</a><br>
														...
														<tr id="comment-43283186" class="comment ">
															<td>
																<table>
																	<tbody>
																		<tr>
																			<td class=" comment-score">&nbsp;<span title="number of 'useful comment' votes received" class = "cool">${c.score }</span>&nbsp;</td>
																			<td>&nbsp;</td>
																		</tr>
																	</tbody>
																</table>
															...
															<td class="comment-text">
																<div style="display: block;" class="comment-body">
																	<span class="comment-copy">${c.text }</span>; 
																	 ...
																	 <c:if test="${c.userId == post.ownerUserId}">
																		...
																		class="relativetime-clean">${c.creationDate }</span></span>
																</div>
															</td>
					...
					<div id="answers">
						...
						<div id="answers-header">
							<div class="subheader answers-subheader">
								<h2>
									${post.answerCount } Answers <span style="display: none;"
										itemprop="answerCount">${post.answerCount }</span>
								</h2>
								<div>
									<div id="tabs">
										<a
								...
								<table>
									<tbody>
										<tr>
											<td class="votecell">
												<div class="vote">
													...
													<a class="vote-up-off" title="This answer is useful">up
														vote</a> <span itemprop="upvoteCount" class="vote-count-post ">${m.score}</span>
											...
											<td class="answercell">
												<div class="post-text" itemprop="text">${m.body }</div>
												<table class="fw">
													<tbody>
														<tr>
															<td class="vt">
																...
																<div class="user-info user-hover">
																	<div class="user-action-time">
																		answered <span title="2014-12-11 10:33:50Z"
																			class="relativetime">${m.writeDate }</span>
																	</div>
																	<div class="user-gravatar32">
										...
										<tr>
											...
											<td>
																...
																<tr id="comment-387639" class="comment ">
																	<td>
																		<table>
																			<tbody>
																				<tr>
																					<td class=" comment-score">&nbsp;<span title="number of 'useful comment' votes received" class = "cool">${mc.score }</span>&nbsp;</td>
																					<td>&nbsp;</td>
																				</tr>
																			</tbody>
																		</table>
																	...
																	<td class="comment-text">
																		<div style="display: block;" class="comment-body">
																			<span class="comment-copy">${mc.text }</span>
																			&ndash;&nbsp; 
																			...
																			<span class="comment-date"
																				...
																				class="relativetime-clean">${mc.creationDate }</span></span>
																		</div>
																	</td>
																</tr>
															</c:forEach>
												...
												<div id="comments-link-575811" data-rep=50 data-anon=true>
													...
													<a class="js-add-link comments-link disabled-link "
														title="Use comments to ask for more information or suggest improvements. Avoid comments like 鈥�+1鈥� or 鈥渢hanks鈥�.">add
														a comment</a><span class="js-link-separator dno">&nbsp;|&nbsp;</span><a
														class="js-show-link comments-link dno"
														title="expand to show all comments on this post, or add one of your own"
														href=# onClick=""></a>
...
StackExchange.ready(function(){$.get('/posts/27420164/ivc/981d');});
	...
	<div id="footer" class="categories">
		<div class="footerwrap">
			...
			<div id="copyright">
				site design / logo 漏 2014 stack exchange inc; user contributions
				licensed under <a
