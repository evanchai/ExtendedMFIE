...
public class FreeDatabase extends Facet{
	...
	public boolean isTrue(String envir) {
		...
		if(envir.contains("MySQL")||envir.contains("SQL")||envir.contains("Sqlite"))
			return false;
		return true;
	}
	...
	public void init(List<Sentence> sentence,Post post,Clause query){
		...
		if(!Free.databaseList.contains(post)&&!postM.containsKey(post))
