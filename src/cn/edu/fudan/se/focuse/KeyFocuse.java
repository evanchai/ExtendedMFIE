...
public class KeyFocuse extends Facet{
...
private List<String> list = new ArrayList<String>();
	...
	private void MatchPattern(Subject subE,Predicate preE,Object objE,Post post)
	{
		if((preE.getSynonyms().contains(Global.ADD)||preE.getSynonyms().contains(Global.CREATE)||
				preE.getSynonyms().contains(Global.DELETE)||preE.getSynonyms().contains(Global.REGARD))
...
//					System.out.println("Clause:"+clause.getClause());
	...
	public void postList(Post post) {
		// TODO Auto-generated method stub
		 //HashMap<Post,Float> super.postM = super.postM;
	}
