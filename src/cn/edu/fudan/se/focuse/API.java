...
public class API extends Facet{
	...
	{
		if((preE.getSynonyms().contains(Global.REGARD)||preE.getSynonyms().contains(Global.SUPPROT)
				||preE.getSynonyms().contains(Global.GET))&&isTrue(objE.getObject()))
		{
