...
public class QueryFocus extends Facet{
	...
	{
		if((preE.getSynonyms().contains(Global.QUERY)&&isTrue(objE.getObject()))||((preE.getSynonyms().contains(Global.USE)||
				preE.getSynonyms().contains(Global.CREATE)||preE.getSynonyms().contains(Global.REGARD))
				&&objE.getObject().toLowerCase().contains("query")))
