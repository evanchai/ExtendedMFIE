...
public class ColumnFocuse extends Facet{
...
private List<String> list = new ArrayList<String>();
	...
	{
		if((preE.getSynonyms().contains(Global.ADD)||preE.getSynonyms().contains(Global.DELETE)
				||preE.getSynonyms().contains(Global.UPDATE)||preE.getSynonyms().contains(Global.REGARD)
				||preE.getSynonyms().contains(Global.QUERY))
