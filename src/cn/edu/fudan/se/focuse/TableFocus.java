...
public class TableFocus extends Facet{
	
	private List<String> list = new ArrayList<String>();
	
	HashMap<Post,Grade> postM = new HashMap<Post,Grade>();
	...
	{
		if((preE.getSynonyms().contains(Global.ADD)||preE.getSynonyms().contains(Global.CREATE)||
				preE.getSynonyms().contains(Global.DELETE)||preE.getSynonyms().contains(Global.SHOW)||
				preE.getSynonyms().contains(Global.UPDATE)||preE.getSynonyms().contains(Global.QUERY))
				&&isTrue(objE.getObject()))
