...
//        
//        System.out.printf(indent + "[Title] ", document.getStringId());
//        System.out.println(post.getPost_title());
//
//        System.out.printf(indent + "[Body]  ", document.getStringId());
//        System.out.println(post.getPost_body());
//        
//        System.out.printf(indent + "[Tag]   ", document.getStringId());
//        System.out.println(post.getPost_tag());
//        
//        System.out.println();
    }
